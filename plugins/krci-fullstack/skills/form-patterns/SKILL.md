---
name: Form Patterns
description: This skill should be used when the user asks to "create form", "implement form", "add validation", "form fields", "multi-step form", "form wizard", "stepper form", or mentions form implementation, field validation, or form state management.
version: 0.2.0
---
...
- **Custom Form Components**: Pre-built, accessible form fields from `@/core/form-temp`
...
All form components are in `/core/form-temp/`:
- **Components**: `/core/form-temp/components/` - 15+ pre-built form fields
- **Context**: `form-context.ts` - field/form context setup
- **Main Export**: `index.ts` - `useAppForm` hook and component exports
...
**Pattern Details:** See `~/.claude/.../memory/form-guide.md`
...
- **Memory Docs**:
  - `~/.claude/.../memory/MEMORY.md` - Project patterns
  - `~/.claude/.../memory/form-guide.md` - FormGuide pattern
