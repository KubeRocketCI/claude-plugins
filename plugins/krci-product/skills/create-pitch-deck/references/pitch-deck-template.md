...
Example:
Title: [Product Name]: The Future of AI-Powered Development
Audience: Tech executives and potential investors at [Industry Conference]
Duration: 10 minutes + 5 minutes Q&A
Objective: Secure [$X] Series A funding and 50 pilot customers
...
> This is a menu of candidate slides. Select the 3-5 that best fit the chosen framework and audience — do not use all twelve. The target length is 3-5 slides maximum.
...
- Teams lose [$X] annually on productivity gaps and context switching
...
Speaker Notes: Imagine if every AI tool you needed was instantly available in your existing IDE with zero configuration. No more API keys, no more documentation, no more setup. Just select, activate, and start building. This is [Product Name].
...
1. Open [IDE Name], click Install [Product Name] - 10 seconds
2. Select [AI Tool A], [AI Tool B], and [AI Tool C] agents - 10 seconds
...
Example:
Title: Riding the [$X] AI Development Wave
Market Size: Developer productivity tools: [$X] market growing 25% annually. AI development tools: [$X] subset with 40% growth
Growth Projections: Expected to reach [$X] by 2027 as AI adoption accelerates across enterprise
Visual: Compelling market growth chart with clear TAM/SAM breakdown. Use credible sources ([Industry Research Sources])
...
- Subscription: [$X]/developer/month for professional features
- Enterprise: [$X]/developer/month with advanced security and compliance
...
- 2,500 active developers using [Product Name] daily
- 300% month-over-month growth in agent installations
- 95% user retention rate after first month of use

Testimonials: Cut our development time in half - CTO, Acme Corp. Finally, AI tools that just work - Lead Developer, Beta Corp
...
- Only platform with native IDE integration across [IDE Name], [IDE 2], and [IDE 3]
...
- CEO: Former VP Engineering at a major tech company, led team of 100+ developers
- CTO: Ex-[Research Institution] researcher, 15 patents in machine learning optimization
- VP Sales: Built [$X] revenue at [Enterprise Software Company], deep enterprise relationships

Execution Record: Previously built and sold DevOps startup to [Major Tech Company] for [$X]. Team delivered 3 successful enterprise products
...
Example:
Title: Path to [$X] ARR in 5 Years
Revenue Forecast: Year 1: [$X] ARR, Year 3: [$X] ARR, Year 5: [$X] ARR. Based on 50,000 paid developers by Year 5
Key Assumptions: Average customer pays [$X]/month, 85% retention rate, 25% annual price increases, 300% net revenue retention
...
Example:
Title: Raising [$X] Series A to Accelerate Growth
Funding Ask: [$X] Series A funding over 18 months
Use of Funds:

- 60% Engineering: Expand platform and add enterprise features ([$X])
- 25% Sales & Marketing: Scale go-to-market and customer acquisition ([$X])
- 15% Operations: Infrastructure, compliance, and administrative scaling ([$X])

Milestones: Reach 10,000 paid developers, [$X] ARR, and enterprise customer proof points
Visual: Simple pie chart showing fund allocation with clear percentages
Speaker Notes: We're asking for [$X] to execute our proven growth plan. This funding takes us to profitability and positions us for a successful Series B. Every dollar is allocated to revenue-generating activities.
...
Contact: `name@example.com` | 555-0123 | example.com/calendar
...
Example: Primary: Secure [$X] Series A funding commitment within 30 days. Secondary: Sign 3 enterprise pilot customers within 60 days. Engagement: 90% of audience requests follow-up meeting. Feedback: Average rating 8.5/10 or higher on presentation effectiveness.
...
- Presentation is 3-5 slides maximum for optimal attention
