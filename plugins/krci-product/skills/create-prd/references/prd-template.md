...
BR-001 [P0]: User can login using biometric authentication with <3 second response
BR-002 [P1]: User can view login history with timestamps and device info
BR-003 [P2]: Admin can configure password complexity requirements

Non-Functional Requirements (NFR) Examples:
NFR-001 [P0]: System supports 1000 concurrent users with <2 second response time
NFR-002 [P1]: System maintains 99.9% uptime during business hours
NFR-003 [P2]: System integrates with enterprise SSO solutions

Use Case Buckets for Epic Creation:
Epic 1: Authentication & Security

- BR-001: Biometric authentication implementation
- NFR-001: Performance and scalability requirements

Epic 2: User Management

- BR-002: User history and account features
- NFR-002: System reliability requirements
