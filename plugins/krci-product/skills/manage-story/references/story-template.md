...
5. Guardrails: NFR limits this story must respect (e.g., perf, security thresholds) — constraints to honor, not cross-cutting features to build here
...
11. Out of Scope: Clarify non-goals — explicitly defer cross-cutting concerns (audit/logging, observability, approval or lifecycle steps owned by other stories) here instead of adding them as criteria above
