...
> Template for a business rules catalog. Populate the `{{variables}}`; repeat the "Detailed Business Rules" block per rule. Omit sections that do not apply and do not emit unpopulated placeholders into the final document.
