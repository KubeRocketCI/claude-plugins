...
Detailed file-level reference for a KubeRocketCI GitLab CI/CD component library. For high-level structure, template anatomy, and spec inputs, see the main SKILL.md.
